    ...
    items: [
      {
        ...
        descripcion:
          "Casitas de colores, mercadillos navideños y un trineo que no era de alquiler. Dos protagonistas dispuestos a probar todo el vino caliente de la región. Por investigación, claro.",
        ...
        portada: "media/viajes/alsacia/img_0700.jpg",
        color: "dorado",
        emoji: "🎄",
        destacado: true,
      },
      {
        ...
        descripcion:
          "Termas humeantes, un parlamento de postal y la eterna duda: ¿estamos en Buda o en Pest? Nadie lo supo nunca, pero el goulash estaba buenísimo.",
        ...
        portada: "media/viajes/budapest/12abba6b-329c-4248-a0ea-3fcdafd2309f.jpg",
        color: "azul",
        emoji: "🌉",
      },
      {
        ...
        descripcion:
          "Un puente romano, mucha montaña y una fabada que cambió vidas. Documental de naturaleza con más sidra de la recomendada por la organización.",
        ...
        portada: "media/viajes/cangas-de-onis/img_6471.jpg",
        color: "verde",
        emoji: "🏔️",
      },
      {
        ...
        descripcion:
          "La serie que vuelve cada verano. Playa, atardeceres y la promesa anual de «este año sí que madrugamos para coger sitio». No madrugaron.",
        ...
        portada: "media/viajes/conil/img_4323.jpg",
        color: "naranja",
        emoji: "🏖️",
      },
      {
      ...
      },
      {
        ...
        descripcion:
          "Road movie gastronómica. Dos ciudades, una misión: probar todos los pinchos de la calle Laurel sin perder la dignidad. Misión cumplida a medias.",
      ...
      },
      {
        ...
        portada: "media/viajes/paris/img_0634.jpg",
        color: "rosa",
        emoji: "🗼",
      },
      {
        ...
        portada: "media/viajes/santillana/img_6136.jpg",
        color: "turquesa",
        emoji: "🏘️",
      },
      {
  ...
  // ==========================================================
  {
    ...
    items: [
      ...
      },
      {
        ...
        descripcion:
          "Seis producciones de bajo presupuesto y altísimo valor sentimental. La cámara tiembla, los protagonistas no.",
